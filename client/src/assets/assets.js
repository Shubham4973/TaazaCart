...
import featured_product from "./featured_product.png";
import featured_product2 from "./featured_product2.png";
...
import tomato_image_4 from "./tomato_image_4.png";
...
import carrot_image_4 from "./carrot_image_4.png";
...
import coca_cola_image_2 from "./coca_cola_image_2.png";
...
import dals_pulses_image from "./dals_pulses_image.png";
import oils_image from "./oils_image.png";
import spices_image from "./spices_image.png";
import snacks_image from "./snacks_image.png";
import cleaning_image from "./cleaning_image.png";
import personal_care_image from "./personal_care_image.png";
import cheese_image from "./cheese_image.png";
import eggs_image_1 from "./eggs_image_1.png";
import eggs_image_2 from "./eggs_image_2.png";
import eggs_image_3 from "./eggs_image_3.png";
import eggs_image_4 from "./eggs_image_4.png";
...
import spinach_image_4 from "./spinach_image_4.png";
...
import onion_image_4 from "./onion_image_4.png";
...
export const features = [
  {
    ...
    description: "Get your essentials at your doorstep in just minutes.",
  },
  {
    icon: leaf_icon,
    title: "Farm-Fresh Quality",
    description: "Handpicked fruits and veggies, delivered at peak freshness.",
  },
  {
    icon: coin_icon,
    title: "Best Value Deals",
    description: "Premium products at prices that fit every budget.",
  },
  {
    icon: trust_icon,
    title: "Trusted Community Choice",
    description: "Serving thousands of satisfied families every day.",
  },
];
...
export const dummyProducts = [
  ...
  },
  {
    ...
    price: 40,
    offerPrice: 35,
    image: [tomato_image_1, tomato_image_3, tomato_image_4, tomato_image_2],
    description: [
      "Juicy and ripe",
      "Rich in Vitamin C",
  ...
  },
  {
    ...
    price: 30,
    offerPrice: 28,
    image: [carrot_image_1, carrot_image_3, carrot_image_2, carrot_image_4],
    description: [
      "Sweet and crunchy",
      "Good for eyesight",
  ...
  },
  {
    ...
    price: 90,
    offerPrice: 85,
    image: [eggs_image_1, eggs_image_3, eggs_image_2, eggs_image_4],
  ...
  // Drinks
  {
    ...
    price: 80,
    offerPrice: 75,
    image: [coca_cola_image_1, coca_cola_image_2],
    description: [
